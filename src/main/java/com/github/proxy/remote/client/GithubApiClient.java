...
@FeignClient(value = "githubApiClient", url = "${github.api.client.url}")
...
public interface GithubApiClient {
    ...
    ResponseEntity<List<GithubRepositoryDto>> getRepositories(@PathVariable("username") String username);
